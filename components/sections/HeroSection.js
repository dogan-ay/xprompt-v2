...
const HeroSection = () => {
  ...
  return (
    <section className="flex justify-around items-center gap-8 lg:gap-0 flex-col-reverse my-20 md:flex-row relative">
      <div className="max-w-lg flex flex-col gap-3 md:gap-7 absolute bottom-[-2rem] md:static bg-slate-900 md:bg-transparent bg-opacity-90 md:bg-opacity-100 backdrop backdrop-blur-sm md:backdrop-blur-none p-2 md:p-0 mx-4 md:mx-0 rounded-xl md:rounded-none">
