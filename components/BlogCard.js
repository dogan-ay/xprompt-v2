...
const BlogCard = () => {
  return (
    <article className="flex flex-col w-44  sm:m-0 sm:flex-row sm:items-center sm:gap-10 rounded-2xl bg-white p-2 sm:p-3 sm:w-full transition group cursor-pointer hover:scale-[1.01] border border-slate-200">
