...
const PageBlogCard = () => {
  return (
    <article className="flex flex-col lg:flex-row lg:items-center lg:gap-10 rounded-2xl bg-white lg:p-3 sm:w-full transition group cursor-pointer sm:hover:scale-[1.01] border border-slate-200">
      <div className="lg:h-72 aspect-square max-h-72 h-40 w-full lg:w-64 lg:rounded-2xl rounded-t-2xl overflow-hidden">
        <img
