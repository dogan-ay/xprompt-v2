...
const PageBlogCard = () => {
  return (
    <article className="flex flex-row items-center gap-10 rounded-2xl bg-white p-3 sm:w-full transition group cursor-pointer sm:hover:scale-[1.01] border border-slate-200">
